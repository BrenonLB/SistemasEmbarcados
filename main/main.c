...
/*Funções da Tarefa do GPTimer (Relógio)*/

/**
 * @brief Callback da ISR do GPTimer
 *
 * @param timer Handle do timer que gerou a interrupção.
 * @param edata Dados do evento de alarme.
 * @param user_ctx Dados do usuário (não utilizado aqui).
 * @return true se a ISR desbloqueou uma tarefa de maior prioridade.
 */
...
/**
 * @brief Tarefa para inicializar o GPTimer e gerenciar o relógio de tempo real.
 */
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG1, "Iniciando aplicacao.");
    ...
    //Inicialização da Tarefa do Timer
